  ...
  <div class="pricing-quoting-wrapper">
      ...
      <div class="row">
        <div class="col-12 big-container">
          <div class="table-responsive d-flex">
            ...
            <div
              class="price"
              style="margin-left: auto; margin-bottom: 30px; padding: 10px"
            >
              <button
      ...
      <div class="modal-content">
        ...
        <form class="group">
          ...
          <input
            type="text"
            id="projectCost1"
            pattern="^[A-Za-z]{1,3}\s?\d+(\.\d{1,2})?$"
            placeholder="High - ₱30,000"
            required
          />
          <label for="projectCost">Cost for Project Complexity:</label>
          <input
      ...
      <div class="modal-content">
        ...
        <form class="group">
          ...
          <textarea
            ...
            placeholder="Input Additional Services"
            required
          ></textarea>
        </form>
        <div class="row">
    ...
    <div id="servicesModal" class="modal">
      <div class="modal-content">
        ...
        <textarea
          id="additional-services"
          placeholder="Web Design, UI Design, Maintainenance"
          required
        ></textarea>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    ...
    const viewIcons = document.querySelectorAll(
      ".status-working i.fas.fa-edit"
    );
